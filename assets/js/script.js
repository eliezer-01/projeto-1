...
document.querySelectorAll('.galeria-estrutura img, .equipe-contato img, .ajuda-container img, .empresa-destaque img, .servicos img').forEach(img => {
